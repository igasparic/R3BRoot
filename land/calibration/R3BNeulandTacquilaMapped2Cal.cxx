...
void R3BNeulandTacquilaMapped2Cal::MakeCal()
{
    ...
    for (Int_t khit = 0; khit < nHits; khit++)
    {
        ...
        {
            LOG(DEBUG) << "R3BNeulandTacquilaMapped2Cal::Exec : Tcal par not found, channel: " << iPlane << " / " << iPaddle << " / " << iSide
            << FairLogger::endl;
            continue;
        }
        ...
        {
            LOG(ERROR) << "R3BNeulandTacquilaMapped2Cal::Exec : error in time calibration: ch=" << channel << ", tdc=" << tdc
        ...
        {
            LOG(DEBUG) << "R3BNeulandTacquilaMapped2Cal::Exec : Tcal par not found, channel: " << iPlane << " / " << iPaddle << " / " << (iSide+2)
            << FairLogger::endl;
            continue;
        }
...
void R3BNeulandTacquilaMapped2Cal::FinishEvent()
{
    ...
    {
        LOG(INFO) << "R3BNeulandTacquilaMapped2Cal::Exec : event=" << fNEvents << " nPMTs=" << fNPmt << FairLogger::endl;
    }
