...
find_path(EPICS_INCLUDE_DIR NAMES cadef.h
...
file(STRINGS $ENV{EPICS_BASE}/config/CONFIG.Host.$ENV{EPICS_HOST_ARCH}
     EPICS_ARCH_CLASS REGEX "ARCH_CLASS[ \t]*=.*")
string(REGEX REPLACE "[^=]*=[ \t]*(.*)" "\\1" EPICS_ARCH_CLASS ${EPICS_ARCH_CLASS})
find_path(EPICS_OS_INCLUDE_DIR NAMES osdEvent.h
  PATHS $ENV{EPICS_BASE}/include/os/${EPICS_ARCH_CLASS}
  NO_DEFAULT_PATH
  DOC   "Path to EPICS OS include header files."
)

find_path(EPICS_LIBRARY_DIR NAMES "libca.so"
  PATHS $ENV{EPICS_BASE}/lib/$ENV{EPICS_HOST_ARCH}
  NO_DEFAULT_PATH
